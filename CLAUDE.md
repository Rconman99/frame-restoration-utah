...
> Last updated: 2026-05-09 (afternoon — second refresh of the day) | Auto-refreshed via Cowork scheduled task
...
- `/supabase/` — **NEW 2026-05-09 (PR #23).** Edge function source-of-truth, previously deployed-only. Currently `supabase/functions/handle-lead/index.ts` (439 lines, v7 OpenRouter / Gemini 2.0 Flash tier classifier — emergency / urgent / scheduled / general / spam routing) + `DEPLOY.md` (deploy + secret-rotation notes). `.gitignore` excludes `supabase/.temp/` (CLI cache); `.vercelignore` should keep `supabase/` off the static CDN.
