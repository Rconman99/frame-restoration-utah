#!/usr/bin/env python3
"""Retired one-off page generator.

This script is intentionally blocked until NAP and compliance copy constants are
...
NOTICE = (
    "RETIRED: add-direct-answer.py is blocked for page generation. "
