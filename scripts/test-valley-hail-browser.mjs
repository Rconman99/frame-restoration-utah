...
let checks=0;
try{
 for(const city of ['hideout','charleston']) for(const [width,height] of [[320,568],[360,800],[393,852],[430,932],[740,360],[1440,1000]]){
 ...
 console.log('PASS Valley guides rendered semantics: '+checks+' checks; no calls, texts or forms submitted');
