...
(function() {
  ...
  css.textContent = [
    '.fr-modal .sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}',
  ...
  overlay.innerHTML = [
    ...
    '      <div class="fr-modal-row"><label for="frModalName" class="sr-only">Full name</label><input id="frModalName" type="text" name="name" placeholder="Full Name" required autocomplete="name"></div>',
    '      <div class="fr-modal-row"><label for="frModalPhone" class="sr-only">Mobile phone</label><input id="frModalPhone" type="tel" name="phone" placeholder="Mobile Phone" required autocomplete="tel"></div>',
    '      <div class="fr-modal-row"><label for="frModalAddress" class="sr-only">Street address (optional)</label><input id="frModalAddress" type="text" name="address" placeholder="Street Address (optional)" autocomplete="street-address"></div>',
    '      <div class="fr-modal-row"><label for="frModalZip" class="sr-only">ZIP code</label><input id="frModalZip" type="text" name="zip" placeholder="ZIP Code" required autocomplete="postal-code" inputmode="numeric" pattern="[0-9]{5}" maxlength="5"></div>',
    ...
    '        <div class="fr-modal-row" style="margin-top:8px"><label for="frModalEmail" class="sr-only">Email address (optional)</label><input id="frModalEmail" type="email" name="email" placeholder="Email Address (optional)" autocomplete="email"></div>',
    '        <div class="fr-modal-row"><label for="frModalCity" class="sr-only">City (optional)</label><input id="frModalCity" type="text" name="city" placeholder="City (optional)"></div>',
    '        <div class="fr-modal-row">',
    '          <label for="frModalIssue" class="sr-only">What\'s going on? (optional)</label>',
    '          <select id="frModalIssue" name="issue">',
